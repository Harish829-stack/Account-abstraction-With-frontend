      ...
      <div className="glass-card flex flex-col gap-5">
        ...
        <h2 className="flex items-center gap-2 text-gradient"><Send size={24} /> New UserOperation</h2>
            ...
            <div className="mt-2 text-sm">
              <button className="flex items-center gap-1 text-muted hover:text-white transition-colors" onClick={() => setShowAdvanced(!showAdvanced)}>
            ...
            <div className="flex gap-3 mt-4">
              <button className="btn btn-secondary flex-1" disabled={pending || isEstimating || !receiver} onClick={handleEstimateGas}>
                {isEstimating ? <div className="flex items-center gap-2"><div className="loader" style={{width:'14px',height:'14px',borderWidth:'2px'}}></div>Estimating...</div> : 'Estimate Gas'}
              </button>
              <button className="btn btn-primary" disabled={pending || isEstimating || !receiver} onClick={handleSendOp} style={{ flex: 2 }}>
                {pending ? 'Signing & Sending...' : 'Sign & Execute Operation'}
              </button>
            </div>
